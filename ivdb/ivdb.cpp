...
void IVdb<PointType>::GenerateNearbyGrids()
{
    ...
    else if (options_.nearby_type_ == NearbyType::NEARBY124)
    {
        ...
        //     Bonxai::CoordT{.x = -1, .y = -2, .z = -2}, Bonxai::CoordT{.x = -1, .y = -2, .z = -1}, Bonxai::CoordT{.x = -1, .y = -2, .z = 0}, Bonxai::CoordT{.x = -1, .y = -2, .z = 1}, Bonxai::CoordT{.x = -1, .y = -2, .z = 2},
        //     Bonxai::CoordT{.x = -1, .y = -1, .z = -2}, Bonxai::CoordT{.x = -1, .y = -1, .z = -1}, Bonxai::CoordT{.x = -1, .y = -1, .z = 0}, Bonxai::CoordT{.x = -1, .y = -1, .z = 1}, Bonxai::CoordT{.x = -1, .y = -1, .z = 2},
        //     Bonxai::CoordT{.x = -1, .y = 0, .z = -2}, Bonxai::CoordT{.x = -1, .y = 0, .z = -1}, Bonxai::CoordT{.x = -1, .y = 0, .z = 0}, Bonxai::CoordT{.x = -1, .y = 0, .z = 1}, Bonxai::CoordT{.x = -1, .y = 0, .z = 2},
        //     Bonxai::CoordT{.x = -1, .y = 1, .z = -2}, Bonxai::CoordT{.x = -1, .y = 1, .z = -1}, Bonxai::CoordT{.x = -1, .y = 1, .z = 0}, Bonxai::CoordT{.x = -1, .y = 1, .z = 1}, Bonxai::CoordT{.x = -1, .y = 1, .z = 2},
        //     Bonxai::CoordT{.x = -1, .y = 2, .z = -2}, Bonxai::CoordT{.x = -1, .y = 2, .z = -1}, Bonxai::CoordT{.x = -1, .y = 2, .z = 0}, Bonxai::CoordT{.x = -1, .y = 2, .z = 1}, Bonxai::CoordT{.x = -1, .y = 2, .z = 2},

        //     Bonxai::CoordT{.x = 0, .y = -2, .z = -2}, Bonxai::CoordT{.x = 0, .y = -2, .z = -1}, Bonxai::CoordT{.x = 0, .y = -2, .z = 0}, Bonxai::CoordT{.x = 0, .y = -2, .z = 1}, Bonxai::CoordT{.x = 0, .y = -2, .z = 2},
        //     Bonxai::CoordT{.x = 0, .y = -1, .z = -2}, Bonxai::CoordT{.x = 0, .y = -1, .z = -1}, Bonxai::CoordT{.x = 0, .y = -1, .z = 0}, Bonxai::CoordT{.x = 0, .y = -1, .z = 1}, Bonxai::CoordT{.x = 0, .y = -1, .z = 2},
        //     Bonxai::CoordT{.x = 0, .y = 0, .z = -2}, Bonxai::CoordT{.x = 0, .y = 0, .z = -1}, Bonxai::CoordT{.x = 0, .y = 0, .z = 0}, Bonxai::CoordT{.x = 0, .y = 0, .z = 1}, Bonxai::CoordT{.x = 0, .y = 0, .z = 2},
        //     Bonxai::CoordT{.x = 0, .y = 1, .z = -2}, Bonxai::CoordT{.x = 0, .y = 1, .z = -1}, Bonxai::CoordT{.x = 0, .y = 1, .z = 0}, Bonxai::CoordT{.x = 0, .y = 1, .z = 1}, Bonxai::CoordT{.x = 0, .y = 1, .z = 2},
        //     Bonxai::CoordT{.x = 0, .y = 2, .z = -2}, Bonxai::CoordT{.x = 0, .y = 2, .z = -1}, Bonxai::CoordT{.x = 0, .y = 2, .z = 0}, Bonxai::CoordT{.x = 0, .y = 2, .z = 1}, Bonxai::CoordT{.x = 0, .y = 2, .z = 2},
